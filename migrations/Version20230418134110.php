 ...
 */
final class Version20230418134110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etat ADD slug INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE sortie ADD campus_id INT NOT NULL, CHANGE date_heure_debut date_heure_debut DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP campus_id, CHANGE date_heure_debut date_heure_debut DATE NOT NULL');

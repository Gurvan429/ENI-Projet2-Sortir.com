 ...
 */
final class Version20230414134345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD createur_id INT NOT NULL');
        $this->addSql('ALTER TABLE sortie ADD CONSTRAINT FK_3C3FD3F273A201E5 FOREIGN KEY (createur_id) REFERENCES participant (id)');
        $this->addSql('CREATE INDEX IDX_3C3FD3F273A201E5 ON sortie (createur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3C3FD3F273A201E5 ON sortie');
        $this->addSql('ALTER TABLE sortie DROP createur_id');
    }
}
